...
namespace AppliSoccerDatabasing
{
    public class MyConfiguration
    {
        ...
        /// <summary>
        /// Get the boolean value of the key from the .config file. If the key is not exists, it will return false.
        /// </summary>
        ...
        /// <summary>
        /// Get the string value of the key from the .config file. If the key is not exists, it will return empty string.
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
